...
| classificação completa de ações | NBR 8681:2025; NBR 8800:2024, 4.8 | todo modo automático | apenas G, peso próprio e uma Q | `combine_elu_normal`, `combine_els`, UI | validações parciais | ausente | NORMATIVE_REVIEW_REQUIRED | não designado |
| ELU normal com variável principal alternada | NBR 8681:2025; NBR 8800:2024, 4.8.7.2.1 | múltiplas ações variáveis | não implementado | futuro `combinations` | ausente | ausente | NOT_IMPLEMENTED | não designado |
...
| ELS quase permanente, frequente e rara | NBR 8681:2025; NBR 8800:2024, 4.8.7.3 | ELS | opção simplificada com uma Q | `combine_els` | testa fator e texto | ausente | NORMATIVE_REVIEW_REQUIRED | não designado |
