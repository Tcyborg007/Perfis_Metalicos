...
- testes: 152 aprovados;
- cobertura total do pacote novo: **89,88 %** com branches;
...
| total do pacote | 89,88 % |

## Conclusão

A meta final de 95 % **não foi atingida**. A medição atual é 89,88 %. O limite de CI em 85 % impede regressão abaixo do
